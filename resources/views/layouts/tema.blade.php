    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <a class="navbar-btn btn btn-sm btn-warning d-none d-lg-inline-block" href="{{ route('admin') }}">
                   Masuk Halaman Admin
                </a>
                @else
                <a class="navbar-btn btn btn-sm btn-warning d-none d-lg-inline-block" href="{{ route('user') }}">
                   Masuk Halaman User
                </a>
                @endif
